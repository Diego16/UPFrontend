...
const mapDispatchToProps = dispatch => {
    return {
        addTask: (title, startDate, endDate, allDay, rrule, description, user, color) => dispatch(tasks.addTask(title, startDate, endDate, allDay, rrule, description, user, color))
    }
}
